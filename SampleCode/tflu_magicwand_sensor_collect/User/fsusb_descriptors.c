...
//
// s_au8ConfigDescriptor
//
static uint8_t s_au8ConfigDescriptor[] = {
    LEN_CONFIG,     /* bLength */
    DESC_CONFIG,    /* bDescriptorType */
    /* wTotalLength */
    FS_LEN_CONFIG_AND_SUBORDINATE & 0x00FF,
    (FS_LEN_CONFIG_AND_SUBORDINATE & 0xFF00) >> 8,
    0x01,           /* bNumInterfaces */
    ...
    (FS_INT_IN_EP_NUM | EP_INPUT), /* bEndpointAddress */
    EP_INT,         /* bmAttributes */
    /* wMaxPacketSize */
    EP2_MAX_PKT_SIZE & 0x00FF,
    (EP2_MAX_PKT_SIZE & 0xFF00) >> 8,
    FS_INT_IN_EP_INTERVAL     /* bInterval */
};
